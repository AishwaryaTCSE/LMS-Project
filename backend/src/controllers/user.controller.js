...
const userController = {
  ...
  updateProfile: async (req, res, next) => {
    try {
      ...
      success(res, { message: 'Profile updated successfully', user: userData });
    } catch (err) {
  ...
  getProfile: async (req, res, next) => {
    try {
      ...
      const { _id, name, email, role, settings } = req.user;
      success(res, { id: _id, name, email, role, settings });
    } catch (err) {
  ...
  exportStudents: async (req, res, next) => {
    try {
  ...
  updateMySettings: async (req, res, next) => {
    try {
  ...
  getAllUsersWithFilters: async (req, res, next) => {
    try {
      const {
        q = '',
        status = 'all',
